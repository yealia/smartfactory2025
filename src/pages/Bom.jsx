...
export default function Bom() {
    ...
    const [form, setForm] = useState({
        vesselId: "", processId: "", blockId: "", materialId: "",
            ...
            >
                <div className="overflow-y-auto pr-2 flex-grow">
                    <div className="grid grid-cols-2 gap-x-6 gap-y-4">
                        ...
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-1">공정 ID</label>
                            <input placeholder="공정 ID" value={form.processId} onChange={(e) => setForm({ ...form, processId: e.target.value })} className="w-full rounded-md border-gray-300 shadow-sm focus:border-sky-500 focus:ring-sky-500" />
                        </div>
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-1">블록 ID</label>
                            <input placeholder="블록 ID" value={form.blockId} onChange={(e) => setForm({ ...form, blockId: e.target.value })} className="w-full rounded-md border-gray-300 shadow-sm focus:border-sky-500 focus:ring-sky-500" />
                        </div>
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-1">자재 ID</label>
                            <input placeholder="자재 ID" value={form.materialId} onChange={(e) => setForm({ ...form, materialId: e.target.value })} className="w-full rounded-md border-gray-300 shadow-sm focus:border-sky-500 focus:ring-sky-500" />
                        </div>
                        <div>
