...
const useCustomerManagement = () => {
    ...
    return {
        customers, selectedCustomer, isEditing, isLoading, message, searchParams,
...
const CustomerDetails = memo(({ customer, isEditing, actions }) => {
            ...
            {customer ? (
                <>
                    <div className="flex-grow overflow-y-auto px-2 pb-4">
                        <DetailFormLayout>
                            <DetailField label="고객ID" isRequired><DetailInput name="customerId" value={customer.customerId} onChange={updateField} readOnly={!customer.isNew} placeholder="예) CUST001" /></DetailField>
                            <DetailField label="고객명" isRequired><DetailInput name="customerNm" value={customer.customerNm} onChange={updateField} readOnly={!isFieldEditable} placeholder="예) Smart Factory" /></DetailField>
                            ...
                            <DetailField label="담당자명" icon="user"><DetailInput name="contactPerson" value={customer.contactPerson} onChange={updateField} readOnly={!isFieldEditable} placeholder="예) 홍길동" className={inputPadding} /></DetailField>
...
export default function CustomerRegister() {
    const { customers, selectedCustomer, isEditing, isLoading, message, searchParams, actions } = useCustomerManagement();
